            ...
            .then(data => 
                people.innerHTML += `
                    <div class="person">
                        ...
                        <div class="information">
                            <div class="inf"><span class="span">Phone:</span> ${data.results[0].phone}</div>
                        </div> 
                        <div class="information">
                            <div class="inf"><span class="span">Name:</span></br> ${Object.values(data.results[0].name).join(" ")}</div>
                        </div>  
                    </div>
                    `    
                ).catch(error =>  {
